...
Cactus AgentLink Rescue v0.5.x can use a local Gemma 4 E4B-it GGUF model through `llama-cli`. The current v0.5.2 GUI field beta does not bundle Brain assets in the Core/portable package.
